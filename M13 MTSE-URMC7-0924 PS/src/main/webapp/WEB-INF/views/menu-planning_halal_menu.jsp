        ...
        <div id = "content-wrap">
          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/menu-planning">Menu Planning</a> > <a href = "/menu-planning_halal">Halal Menus</a> > <span>Halal Menu</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Menu Planning (Halal Menu) </u> </h1>


              <br />


              <form:form id = "form" name = "form" method = "post" action = "/menu-planning_halal_menu" modelAttribute = "menu">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <form:hidden path = "diet" value = "Halal" />
