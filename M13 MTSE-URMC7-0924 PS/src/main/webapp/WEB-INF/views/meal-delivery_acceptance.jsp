        ...
        <div id = "content-wrap">
          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/meal-delivery">Meal Delivery</a> > <span>Available Pickups (Acceptance)</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Available Pickups (Acceptance) </u> </h1>


              <br />


              <form:form id = "form" name = "form" method = "post" action = "/meal-delivery_acceptance" modelAttribute = "selectWrapper">
                  ...
                  <tr id = "page-navigation">
                    ...
                    <td colspan = "14" style = "text-align: right">
                      ...
                      <c:if test = "${not empty meals}">
                        ...
                        <c:if test = "${current > 0}">
                        <a href="/meal-delivery_acceptance?page=${current-1}&size=${size}">Prev</a>
                        </c:if>

                        <c:forEach begin = "0" end = "${pages - 1}" var = "i">

                        <c:if test = "${i != current}">
                        <a href="/meal-delivery_acceptance?page=${i}&size=${size}"><c:out value = "${i + 1}" /></a>
                        </c:if>
                        ...
                        <a href="/meal-delivery_acceptance?page=${current+1}&size=${size}">Next</a>
                        </c:if>
                  ...
                  <tr>
                    ...
                    <td style = "width: 220px">
                      ...
                      <div style = "text-align: left">
                        ...
                        <form:button style = "width: 100px"> Accept </form:button>
