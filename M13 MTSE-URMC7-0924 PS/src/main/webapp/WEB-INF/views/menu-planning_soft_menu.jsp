        ...
        <div id = "content-wrap">
          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/menu-planning">Menu Planning</a> > <a href = "/menu-planning_soft">Soft Menus</a> > <span>Soft Menu</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Menu Planning (Soft Menu) </u> </h1>


              <br />


              <form:form id = "form" name = "form" method = "post" action = "/menu-planning_soft_menu" modelAttribute = "menu">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <form:hidden path = "diet" value = "Soft" />
