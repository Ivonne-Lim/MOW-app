          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/evaluation">Evaluation</a> > <a href = "/evaluation_members">Members</a> >
                <a href = "/evaluation_members_member?id=${member.id}">Member</a> > <span>Caregivers</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Evaluation (Caregivers) </u> </h1>
                ...
                <tr>
                  ...
                  <td style = "width: 220px; border: 1px solid black;">
                    ...
                    <div style = "display: flex; gap: 20px;">
                      ...
                      <form name = "update" method = "get" action = "/evaluation_members_member_caregivers_caregiver">
                        <input type = "hidden" name = "id"        value = "${caregiver.id}" />
                        <input type = "hidden" name = "member_id" value = "${member.id}"   />
                        <input type = "submit" name = "submit"    value = "Update" style = "width: 100px" />
                      </form>
  
                      <form name = "delete" method = "post" action = "/evaluation_members_member_caregivers_deletion">
                ...
                <tr id = "page-navigation">
                  ...
                  <td colspan = "7" style = "text-align: right">
                    ...
                    <c:if test = "${not empty caregivers}">
                      ...
                      <c:if test = "${current > 0}">
                      <a href="/evaluation_members_member_caregivers?member_id=${member.id}&page=${current-1}&size=${size}">Prev</a>
                      </c:if>

                      <c:forEach begin = "0" end = "${pages - 1}" var = "i">

                      <c:if test = "${i != current}">
                      <a href="/evaluation_members_member_caregivers?member_id=${member.id}&page=${i}&size=${size}"><c:out value = "${i + 1}" /></a>
                      </c:if>
                      ...
                      <a href="/evaluation_members_member_caregivers?member_id=${member.id}&page=${current+1}&size=${size}">Next</a>
                      </c:if>
