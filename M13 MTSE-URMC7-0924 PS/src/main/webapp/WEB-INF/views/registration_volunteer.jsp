        ...
        <div id = "content-wrap">
          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/registration">Registration</a> > <span>Volunteer</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Registration (Volunteer) </u> </h1>


              <br />


              <form:form id = "form" name = "form" method = "post" action = "/registration_volunteer" modelAttribute = "volunteer">
                ...
                <table style = "float: left">
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <input type = "text" id = "nric_uen" name = "nric_uen" value = "${volunteer.nric_uen}" required = "true" maxlength = "10" size = "10" pattern = "^[A-Za-z0-9]{0,10}$" /> <br />
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <form:select path = "role">
                        <form:option label = "Food Service Provider (FSP)" value = "Volunteer - FSP" />
                        <form:option label = "Food Delivery Rider (FDR)"   value = "Volunteer - FDR" />
                      </form:select> <br />
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <input type = "text" id = "postal" name = "postal" value = "${volunteer.postal}" required = "true" maxlength = "6" size = "6" pattern = "^[0-9]{0,6}$" /> <br />
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <c:if test = "${volunteer.status == null || volunteer.status == ''}">
                      ...
                      <c:if test = "${volunteer.status != null && volunteer.status != ''}">
                        ...
                        <span> <c:out value = "${volunteer.status}" /> </span> <br />
                      </c:if>
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <c:if test = "${volunteer.notes == null || volunteer.notes == ''}"> <span> - </span> <br /> </c:if>

                      <c:if test = "${volunteer.notes != null && volunteer.notes != ''}"> <span> <c:out value = "${volunteer.notes}" /> </span> <br /> </c:if>
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <select name = "menu_halal_id" style = "width: 600px"
                        <c:if test = "${volunteer.role == null || volunteer.role == '' || volunteer.role != 'Volunteer - FSP'}"> disabled </c:if> >

                            <option value = "" <c:if test = "${empty volunteer.menu_halal}"> selected </c:if> > </option>

                        <c:if test = "${not empty menusHalal}">
                          <c:forEach var = "menuHalal" items = "${menusHalal}">

                            <option value = "${menuHalal.id}" <c:if test = "${not empty volunteer.menu_halal && volunteer.menu_halal.id == menuHalal.id}"> selected </c:if> >
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <select name = "menu_veg_id" style = "width: 600px"
                        <c:if test = "${volunteer.role == null || volunteer.role == '' || volunteer.role != 'Volunteer - FSP'}"> disabled </c:if> >
                            ...
                            <option value = "" <c:if test = "${empty volunteer.menu_veg}"> selected </c:if> > </option>

                        <c:if test = "${not empty menusVeg}">
                          <c:forEach var = "menuVeg" items = "${menusVeg}">

                            <option value = "${menuVeg.id}" <c:if test = "${not empty volunteer.menu_veg && volunteer.menu_veg.id == menuVeg.id}"> selected </c:if> >
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <select name = "menu_soft_id" style = "width: 600px"
                        <c:if test = "${volunteer.role == null || volunteer.role == '' || volunteer.role != 'Volunteer - FSP'}"> disabled </c:if> >
                            ...
                            <option value = "" <c:if test = "${empty volunteer.menu_soft}"> selected </c:if> > </option>

                        <c:if test = "${not empty menusSoft}">
                          <c:forEach var = "menuSoft" items = "${menusSoft}">

                            <option value = "${menuSoft.id}" <c:if test = "${not empty volunteer.menu_soft && volunteer.menu_soft.id == menuSoft.id}"> selected </c:if> >
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <select name = "menu_normal_id" style = "width: 600px"
                        <c:if test = "${volunteer.role == null || volunteer.role == '' || volunteer.role != 'Volunteer - FSP'}"> disabled </c:if> >
                            ...
                            <option value = "" <c:if test = "${empty volunteer.menu_normal}"> selected </c:if> > </option>

                        <c:if test = "${not empty menusNormal}">
                          <c:forEach var = "menuNormal" items = "${menusNormal}">

                            <option value = "${menuNormal.id}" <c:if test = "${not empty volunteer.menu_normal && volunteer.menu_normal.id == menuNormal.id}"> selected </c:if> >
                  ...
                  <tr>
                    ...
                    <td style = "border: 1px solid black" colspan = "3">
                      ...
                      <select name = "provider_id" style = "width: 600px"
                        <c:if test = "${volunteer.role == null || volunteer.role == '' || volunteer.role != 'Volunteer - FDR'}"> disabled </c:if> >

                            <option value = "" <c:if test = "${empty volunteer.provider}"> selected </c:if> > </option>

                        <c:if test = "${not empty providers}">
                          <c:forEach var = "provider" items = "${providers}">

                            <option value = "${provider.id}" <c:if test = "${not empty volunteer.provider && volunteer.provider.id == provider.id}"> selected </c:if> >
