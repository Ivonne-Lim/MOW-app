        ...
        <div id = "content-wrap">
          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/meal-preparation">Meal Preparation</a> > <span>Vegetarian Meals</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Meal Preparation (Vegetarian Meals) </u> </h1>


              <br />


              <form:form id = "form" name = "form" method = "post" action = "/meal-preparation_veg_updation" modelAttribute = "selectWrapper">
                  ...
                  <tr style = "background-color: lightgray">
                    ...
                    <th style = "border: 1px solid black">
                      ...
                      <div style = "display: flex; gap: 25px;">
                        ...
                        <sec:authorize access = "hasAnyRole('PARTNER - FSP', 'VOLUNTEER - FSP')">
                        <input type = "submit" name = "submit" value = "Generate" style = "width: 100px" formmethod = "post" formaction= "/meal-preparation_veg_generation" /> <br />
                        </sec:authorize>

                        <sec:authorize access = "hasAnyRole('ADMINISTRATOR', 'MEMBER')">
                        <input type = "submit" name = "submit" value = "Generate" style = "width: 100px" formmethod = "post" formaction= "/meal-preparation_veg_generation" disabled = "true" /> <br />
                        </sec:authorize>
                  ...
                  <tr id = "page-navigation">
                    ...
                    <td colspan = "14" style = "text-align: right">
                      ...
                      <c:if test = "${not empty meals}">
                        ...
                        <c:if test = "${current > 0}">
                        <a href="/meal-preparation_veg?page=${current-1}&size=${size}">Prev</a>
                        </c:if>

                        <c:forEach begin = "0" end = "${pages - 1}" var = "i">

                        <c:if test = "${i != current}">
                        <a href="/meal-preparation_veg?page=${i}&size=${size}"><c:out value = "${i + 1}" /></a>
                        </c:if>
                        ...
                        <a href="/meal-preparation_veg?page=${current+1}&size=${size}">Next</a>
                        </c:if>
                  ...
                  <tr>
                    ...
                    <td style = "width: 220px">
                      ...
                      <div style = "display: flex; gap: 20px;">
                        ...
                        <input type = "submit" name = "submit" value = "Delete" style = "width: 100px" formmethod = "post" formaction = "/meal-preparation_veg_deletion" /> <br />
                        </sec:authorize>

                        <sec:authorize access = "hasAnyRole('ADMINISTRATOR', 'MEMBER')">
                        <form:button style = "width: 100px" disabled = "true"> Update </form:button>
                        <input type = "submit" name = "submit" value = "Delete" style = "width: 100px" formmethod = "post" formaction = "/meal-preparation_veg_deletion" disabled = "true" /> <br />
                        </sec:authorize>
                      ...
                      <div style = "display: flex; gap: 20px;">
                        ...
                        <sec:authorize access = "hasAnyRole('PARTNER - FSP', 'VOLUNTEER - FSP')">
                        <input type = "submit" name = "submit" value = "Print" style = "width: 100px" formmethod = "post" formaction = "/meal-preparation_veg_printing" /> <br />
                        </sec:authorize>

                        <sec:authorize access = "hasAnyRole('ADMINISTRATOR', 'MEMBER')">
                        <input type = "submit" name = "submit" value = "Print" style = "width: 100px" formmethod = "post" formaction = "/meal-preparation_veg_printing" disabled = "true" /> <br />
                        </sec:authorize>
