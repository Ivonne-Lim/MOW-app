        ...
        <div id = "content-wrap">
          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/evaluation">Evaluation</a> > <span>Volunteers</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Evaluation (Volunteers) </u> </h1>
              ...
              <table>
                ...
                <tr style = "background-color: lightgray">
                  ...
                  <th style = "border: 1px solid black"> <span> Role      </span> <br/> </th>
                  ...
                  <th style = "border: 1px solid black"> <span> Action(s) </span> <br /> </th>
                ...
                <tr>
                  ...
                  <td style = "width: 18ch; border: 1px solid black;">  <p> </p> </td>
                ...
                <tr>
                  ...
                  <td style = "width:  5ch; border: 1px solid black;">  <span> <c:out value = "${volunteer.id}"       /> </span> <br /> </td>


                  <td style = "width: 12ch; border: 1px solid black;">  <span> <c:out value = "${volunteer.nric_uen}" /> </span> <br /> </td>


                  <td style = "width: 42ch; border: 1px solid black;">  <span> <c:out value = "${volunteer.names}"    /> </span> <br /> </td>


                  <td style = "width: 22ch; border: 1px solid black;">  <span> <c:out value = "${volunteer.surname}"  /> </span> <br /> </td>


                  <td style = "width: 18ch; border: 1px solid black;">  <span> <c:out value = "${volunteer.role}"     /> </span> <br /> </td>


                  <td style = "width: 12ch; border: 1px solid black;">  <span> <c:out value = "${volunteer.phone}"    /> </span> <br /> </td>


                  <td style = "width: 12ch; border: 1px solid black;">  <span> <c:out value = "${volunteer.status}"   /> </span> <br /> </td>
                  ...
                  <td style = "width: 220px; border: 1px solid black;">
                    ...
                    <div style = "display: flex; gap: 20px;">
                      ...
                      <form name = "update" method = "get" action = "/evaluation_volunteers_volunteer">
                        <input type = "hidden" name = "id"        value = "${volunteer.id}" />
                        <input type = "submit" name = "submit"    value = "Update" style = "width: 100px" />
                      </form>
  
                      <form name = "delete" method = "post" action = "/evaluation_volunteers_deletion">
                ...
                <tr id = "page-navigation">
                  ...
                  <td colspan = "8" style = "text-align: right">
                    ...
                    <c:if test = "${not empty volunteers}">
                      ...
                      <c:if test = "${current > 0}">
                      <a href="/evaluation_volunteers?page=${current-1}&size=${size}">Prev</a>
                      </c:if>

                      <c:forEach begin = "0" end = "${pages - 1}" var = "i">

                      <c:if test = "${i != current}">
                      <a href="/evaluation_volunteers?page=${i}&size=${size}"><c:out value = "${i + 1}" /></a>
                      </c:if>
                      ...
                      <a href="/evaluation_volunteers?page=${current+1}&size=${size}">Next</a>
                      </c:if>
