        ...
        <div id = "content-wrap">
          ...
          <main id = "main">
            ...
            <div id = "breadcrumb">
              ...
              <a href = "/home">Home</a> > <a href = "/menu-planning">Menu Planning</a> > <span>Normal Menus</span>
            ...
            <div id = "content">
              ...
              <h1> <u> Menu Planning (Normal Menus) </u> </h1>
                ...
                <tr style = "background-color: lightgray">
                  ...
                  <th style = "border: 1px solid black">
                    ...
                    <div style = "display: flex; gap: 60px;">
                      ...
                      <form name = "create" method = "get" action = "/menu-planning_normal_menu">
                ...
                <tr>
                  ...
                  <td style = "width: 220px; border: 1px solid black;">
                    ...
                    <div style = "display: flex; gap: 20px;">
                      ...
                      <form name = "update" method = "get" action = "/menu-planning_normal_menu">
                        <input type = "hidden" name = "id"        value = "${menu.id}" />
                        <input type = "submit" name = "submit"    value = "Update" style = "width: 100px" />
                      </form>
  
                      <form name = "delete" method = "post" action = "/menu-planning_normal_deletion">
                ...
                <tr id = "page-navigation">
                  ...
                  <td colspan = "8" style = "text-align: right">
                    ...
                    <c:if test = "${not empty menus}">
                      ...
                      <c:if test = "${current > 0}">
                      <a href="/menu-planning_normal?page=${current-1}&size=${size}">Prev</a>
                      </c:if>

                      <c:forEach begin = "0" end = "${pages - 1}" var = "i">

                      <c:if test = "${i != current}">
                      <a href="/menu-planning_normal?page=${i}&size=${size}"><c:out value = "${i + 1}" /></a>
                      </c:if>
                      ...
                      <a href="/menu-planning_normal?page=${current+1}&size=${size}">Next</a>
                      </c:if>
